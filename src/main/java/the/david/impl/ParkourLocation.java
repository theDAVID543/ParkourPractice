...
public class ParkourLocation{
	...
	void loadData(){
		...
		int score = DataHandler.getInt(configPath + ".Score");
		if(score != 0){
			this.score = score;
			DebugOutputHandler.sendDebugOutput("score : " + score);
		}
		Boolean canUsePractice = DataHandler.getBoolean(configPath + ".CanUsePractice");
		if(Boolean.FALSE.equals(canUsePractice)){
			this.canUsePractice = false;
		}
	}

	public void setScore(int score){
		this.score = score;
		DataHandler.setInt(configPath + ".Score", score);
	}
	...
	public void setCanUsePractice(boolean canUsePractice){
		this.canUsePractice = canUsePractice;
		DataHandler.setBoolean(configPath + ".CanUsePractice", canUsePractice);
	}
	...
	public boolean getCanUsePractice(){
		return canUsePractice;
	}
